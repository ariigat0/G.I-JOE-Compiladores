...
_lr_productions = [
  ...
  ('flow -> VARIABLE CONNECT flow_functions','flow',3,'p_flow','translator.py',135),
  ('flow_functions -> flow_function_call CONNECT flow_functions','flow_functions',3,'p_flow_functions','translator.py',153),
  ('flow_functions -> flow_function_call','flow_functions',1,'p_flow_functions_alone','translator.py',169),
  ('flow_function_call -> VARIABLE LPAREN params RPAREN','flow_function_call',4,'p_flow_function_call','translator.py',175),
  ('assignment -> expression','assignment',1,'p_assignment_expression','translator.py',188),
  ('expression -> term','expression',1,'p_expression_term','translator.py',194),
  ('expression -> string_def','expression',1,'p_expression_term','translator.py',195),
  ('string_def -> STRING','string_def',1,'p_string_def','translator.py',201),
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','translator.py',207),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','translator.py',217),
  ('term -> exponent','term',1,'p_term_exponent','translator.py',227),
  ('term -> term TIMES exponent','term',3,'p_term_times','translator.py',233),
  ('term -> term DIV exponent','term',3,'p_term_divides','translator.py',243),
  ('exponent -> factor','exponent',1,'p_exponent_factor','translator.py',253),
  ('exponent -> factor EXP factor','exponent',3,'p_exponent_exp','translator.py',259),
  ('factor -> NUMBER','factor',1,'p_factor_num','translator.py',270),
  ('factor -> VARIABLE','factor',1,'p_factor_variable','translator.py',281),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','translator.py',287),
  ('factor -> function_call','factor',1,'p_factor_function_call','translator.py',296),
  ('function_call -> VARIABLE LPAREN RPAREN','function_call',3,'p_function_call_no_params','translator.py',302),
  ('function_call -> VARIABLE LPAREN params RPAREN','function_call',4,'p_function_call_params','translator.py',308),
  ('params -> params COMMA expression','params',3,'p_params','translator.py',320),
  ('params -> expression','params',1,'p_params','translator.py',321),
]
